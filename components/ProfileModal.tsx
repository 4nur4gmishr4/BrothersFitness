                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <label className="label-text text-[10px] text-low ml-1">Full Name</label>
                        ...
                        {/* Date of Birth */}
                        <div className="space-y-1">
                            <label className="label-text text-[10px] text-low ml-1">Date of Birth</label>
                            <div className="relative">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-1">
                                <label className="label-text text-[10px] text-low ml-1">Height</label>
                                <div className="relative">
                            ...
                            <div className="space-y-1">
                                <label className="label-text text-[10px] text-low ml-1">Weight</label>
                                <div className="relative">
                        ...
                        {/* Gender */}
                        <div className="space-y-1">
                            <label className="label-text text-[10px] text-low ml-1">Gender</label>
                            <div className="flex items-center gap-3">
