            ...
            <div>
              <div className="flex items-center justify-between mb-4 md:mb-6">
                <div className="flex items-center gap-3 text-accent">
                  ...
                  <p className="label-text text-[10px] tracking-widest text-low uppercase font-mono">
                    EST. 2024 // LAKHNADON
                  </p>
                </div>
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 mb-8 md:mb-12">
                <span className="px-2 py-1 md:px-3 md:py-1.5 bg-surface-elevated border border-surface-border text-[10px] md:text-xs font-mono text-low uppercase tracking-wider">
          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-3 md:gap-5 justify-between flex-grow">
            ...
            >
              ...
              <div className="flex justify-between items-start z-10">
                ...
                <div className="flex flex-col items-end gap-1">
                  <span className="px-2 py-1 bg-accent/10 border border-accent/20 text-accent font-mono text-[10px] uppercase tracking-widest flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-accent animate-pulse" />
                    Real-Time Feed
                  </span>
                  <span className="text-[10px] font-mono text-faint">UPDATED TODAY</span>
                </div>
              </div>
                    ...
                    {displayBars.map((item, idx) => {
                      ...
                      return (
                        <div key={item.month} className="flex-1 h-full flex flex-col items-center justify-end group/bar relative">
                          ...
                          <span className={`text-[10px] font-mono mb-1 text-accent font-bold transition-transform ${isToday ? "scale-110" : "group-hover/bar:scale-110"}`}>
                            {item.count}
                          </span>
                          ...
                          {/* Month Label */}
                          <span className={`text-[10px] font-mono mt-2 tracking-wider uppercase transition-colors ${
            ...
            >
               <div className="z-10 flex flex-col items-start gap-1 max-w-[60%]">
                 ...
                 <p className="text-[10px] md:text-xs text-mid leading-relaxed mb-1">Personalized nutrition plan strictly calibrated to your goals.</p>
                 <Link href="/fuel" className="mt-1 inline-flex items-center gap-1.5 text-[10px] uppercase tracking-widest text-accent font-bold group-hover:text-hi transition-colors">
