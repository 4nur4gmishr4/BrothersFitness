    ...
    return (
        <div ref={ref} className="bg-white text-black p-8 max-w-[800px] mx-auto text-sm leading-relaxed hidden-print-view font-sans">
            ...
            <div className="text-center pt-8 border-t-2 border-black mt-12">
                <p className="font-black text-2xl uppercase tracking-[0.5em] text-gray-300">Brother&apos;s Fitness</p>
                <p className="text-xs uppercase text-gray-400 mt-2">Generated by Brother&apos;s Fitness Diet Planner</p>
            </div>
