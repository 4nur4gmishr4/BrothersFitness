        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center max-w-2xl mx-auto space-y-8">
                ...
                >
                    ...
                    <p className="font-mono text-gray-400 text-sm md:text-base leading-relaxed mb-8 max-w-lg mx-auto border-l-2 border-gym-red pl-4 text-left">
                        &gt; MISSION CONTROL REPORTED A FAULT<br />
                        &gt; TRANSMISSION LOST ON THIS SECTOR<br />
                ...
                >
                    ...
                    >
                        <RotateCcw className="w-5 h-5 group-hover:-translate-y-1 transition-transform" />
                        Re-establish Uplink
                    </button>
                </motion.div>
            </div>
            ...
            <div className="absolute bottom-8 left-0 right-0 text-center">
                <p className="font-mono text-xs text-gray-600 uppercase tracking-[0.2em] animate-pulse">
                    SYSTEM STATUS: ERROR {error.digest ? `// CODE ${error.digest}` : ""}
                </p>
            </div>
        </div>
    );
